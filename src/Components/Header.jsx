    ...
    <div className='sticky top-0 z-10 flex flex-row items-center justify-between h-14 px-4 md:px-5 bg-black'>
      {loading && <Loader/>}
        ...
        <div className="group flex items-center ">
          <div className="flex h-9 md:h-10 md:ml-10 md:pl-5 border border-[#555555] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0 ">
          ...
          <button onClick={()=> searchQueryHandler("searchButton")} className='w-[40px] md:w-[60px] h-9 md:h-10 flex items-center justify-center border border-l-0 border-[#555555] rounded-r-3xl bg-white/[0.1]  '>
            <IoIosSearch className='text-white text-xl' />
          </button>
        </div>
